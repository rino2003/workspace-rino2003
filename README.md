# com-chilipeppr-workspace-rino
A ChiliPeppr Workspace rino.
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-rino |
| Name                  | Workspace / Sample |
| Description           | A ChiliPeppr Workspace rino. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/rino2003/workspace-rino2003/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/rino20031/sample |
| Github URL            | http://github.com/rino2003/workspace-rino2003 |
| Test URL              | https://preview.c9users.io/rino20031/sample/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/rino2003/workspace-rino2003/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-rino"], // the id you gave your workspace
      function(myWorkspaceRino) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / Sample just got loaded.", myWorkspaceRino);
        myWorkspaceRino.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-rino"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Sample"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace rino."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/rino2003/workspace-rino2003/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/rino20031/sample"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/rino2003/workspace-rino2003"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://sample-rino20031.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
