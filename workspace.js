...
cprequire_test(["inline:com-chilipeppr-workspace-rino"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-rino", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-rino", // Make the id the same as the cpdefine id
        name: "Workspace / Sample", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace rino.`,
